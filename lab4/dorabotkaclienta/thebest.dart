...
class _WheelControllerPageState
      ...
      if (type == 'snapshot') {
        ...
        setState(() {
          ...
          if (loadedRows.isNotEmpty) {
            ...
            baseSize = last.baseSize
                .clamp(0.1, 1.0)
                .toDouble();

            wheelRadius = last.wheelRadius
                .clamp(0.01, 0.2)
                .toDouble();
          }
        });
  ...
  void _restoreLogRow(
    ...
    setState(() {
      ...
      baseSize =
          row.baseSize.clamp(0.1, 1.0).toDouble();
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          onPressed:
                          selectedIndex < logRows.length - 1
                              ? () {
                            setDialogState(() {
                              selectedIndex++;
                            });
  ...
  void _startSimulation() {
    ...
    timer = Timer.periodic(
      const Duration(
        ...
        setState(() {
          robotX += currentLinearSpeed *
              math.cos(robotAngle) *
              timeStep;

          robotY += currentLinearSpeed *
              math.sin(robotAngle) *
              timeStep;
